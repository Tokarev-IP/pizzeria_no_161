...
import com.iliatokarev.pizzeriano161.presentation.orders.common.RejectionReasonUseCase
...
val mainModule = module {
    ...
    factoryOf(::RejectionReasonUseCase) { bind<RejectionReasonUseCaseInterface>() }
}